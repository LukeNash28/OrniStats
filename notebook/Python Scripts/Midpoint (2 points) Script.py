...
refs = pd.DataFrame(pd.read_excel("/Users/lukenash1/Documents/OrniStats/notebook/Public/Rare Bird Data - Main.xlsx",sheet_name="Location Co-ordinates"))
refs.set_index("site",inplace=True)
inputData = pd.DataFrame(pd.read_excel("/Users/lukenash1/Documents/OrniStats/notebook/Public/Rare Bird Data - Main.xlsx",sheet_name="Dual Import"))
outputData = None
...
midpoint(inputData)
outputData.to_csv('/Users/lukenash1/Documents/OrniStats/notebook/Private/ROI 2021 2 MP Output.csv',index = False)
